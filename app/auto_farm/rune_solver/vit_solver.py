...
class ViTSolver:
    ...
    def _proportional_resize_center_crop(
        ...
        """Stretch to target width and height to preserve the entire image content.

        Stretching (direct resize) is much more robust than cropping because
        the latter cuts off the left/right margins where the first and last
        arrows are located.
        """
